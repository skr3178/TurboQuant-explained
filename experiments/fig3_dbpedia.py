"""
Figure 3: Distortion vs bitwidth on DBpedia 1536d (2 panels).
...
def main():
    ...
    fig.suptitle(
        "Figure 3: Distortion vs Bit-width (DBpedia 1536d)",
    ...
    plt.tight_layout()
    path = os.path.join(results_dir, "Fig_3_dbpedia.png")
